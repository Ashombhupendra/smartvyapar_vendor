...
class ApiClient extends GetxService {
  ...
  late Map<String, String> _mainHeaders2;
  ...
  Future<Response> getData2(String uri, {Map<String, dynamic>? query, Map<String, String>? headers, bool handleError = true}) async {
    try {
      debugPrint('====> API Call: $uri\nHeader: $_mainHeaders');
      SharedPreferences sharedPreferences = await SharedPreferences.getInstance();
     String? zone =  sharedPreferences.getString(AppConstants.zoneTopic);
      String? type =  sharedPreferences.getString(AppConstants.type);
      String? token=  sharedPreferences.getString(AppConstants.token);
      String? module=  sharedPreferences.getString(AppConstants.moduleId);
      String? language=  sharedPreferences.getString(AppConstants.languageCode);
      print("zone id=> ${zone}");
      http.Response response = await http.get(
        Uri.parse(appBaseUrl+uri),
        headers: {
